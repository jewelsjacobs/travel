...
11. [Restangular](https://github.com/mgonto/restangular) AngularJS module as opposed to $http or $resource
12. Express backend API consumed via Lineman's server proxy
13. [Livereload plugin](https://github.com/linemanjs/lineman-livereload)
14. [Bower plugin](https://github.com/linemanjs/lineman-bower)
