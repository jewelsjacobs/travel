/**
 Expedia module handling hotel information and booking - hotel availability, create booking, hotel info, etc.
 ...
 public methods
 1. search
 2. getHotelAcceptedPayments
 3. getHotelAvailability
 4. getHotelInfo
 5. getHotels
 6. getRoomImages
 7. ping
...
/**
 ...
 @param {Object} user
 **/
Expedia.prototype.create = function(db, data, params)
{
    var deferred = Q.defer();
    var ret ={code:0, msg:'Expedia.create '};
...
/**
 ...
 @param {Object} user
 **/
Expedia.prototype.login = function(db, data, params) {
    var deferred = Q.defer();
    var ret ={code:0, msg:'Expedia.login '};
...
/**
 ...
 @param {Object} user
 **/
Expedia.prototype.logout = function(db, data, params) {
    var deferred = Q.defer();
    var ret ={code:0, msg:'Expedia.logout '};
...
/**
 ...
 @param {Object} user
 **/
Expedia.prototype.checkLogin = function(db, data, params) {
    var deferred = Q.defer();
    var ret ={code:0, msg:'Expedia.checkLogin ', user:false};
 ...
 **/
Expedia.prototype.forgotPassword = function(db, data, params) {
    var deferred = Q.defer();
    var ret ={code:0, msg:'Expedia.forgotPassword '};
...
/**
 ...
 @param {Object} user
 **/
Expedia.prototype.resetPassword = function(db, data, params) {
    var deferred = Q.defer();
    var ret ={code:0, msg:'Expedia.resetPassword ', user:false};
...
/**
 ...
 @param {Object} user
 **/
Expedia.prototype.changePassword = function(db, data, params) {
    var deferred = Q.defer();
    var ret ={code:0, msg:'Expedia.changePassword ', user:false};
...
/**
 ...
 @param {Object} user
 **/
Expedia.prototype.createGuest = function(db, guest, params)
{
    var deferred =Q.defer();
    var ret = {'code': 0, 'msg': 'Expedia.createGuest ', 'user': {} };
 ...
 */
Expedia.prototype.formatAlternateContact = function(user, params)
{
    var ii;
    var found;
 ...
 **/
Expedia.prototype.userImport = function(db, data, params)
{
    var deferred =Q.defer();
    var ret = {'code': 0, 'msg': 'Expedia.userImport ', 'user': {}, 'already_exists': false };
 ...
 **/
Expedia.prototype.usersImport = function(db, data, params)
{
    var deferred =Q.defer();
    var ret = {'code': 0, 'msg': 'Expedia.usersImport ', 'users': [] };
 ...
 **/
Expedia.prototype.userExists = function(db, user, params)
{
    var deferred = Q.defer();
    ...
    else
    {
        ...
        console.log("Expedia.userExists: Error: No _id, email, or phone given. Cannot check if user exists");
        deferred.reject(ret);
    }
...
/**
 ...
 @param {Boolean} already_exists True iff the given user is already in the database.
 **/
Expedia.prototype.socialLogin = function(db, data, params)
{
    var deferred =Q.defer();
    var ret = {'code': 0, 'msg': 'Expedia.socialLogin ', 'user': {}, 'already_exists': false };
...
/**
 ...
 @param {String} msg
 */
//Expedia.prototype.checkEmail =function(email, params) {
